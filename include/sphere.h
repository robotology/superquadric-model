...
/**
  ...
  * and returns the estiamted sphere, better fitting a given point cloud.
  */
class  Sphere_NLP : public Ipopt::TNLP
{
...
protected:
   ...
   */
    ...
    * @param x0 is the initial value for the sphere to be estimated
    * @param point_cloud is the object point cloud
    */
    /****************************************************************/
    void computeX0(yarp::sig::Vector &x0, std::deque<yarp::sig::Vector> &point_cloud);

    /** Compute initial sphere orientation from the point cloud
    * @param x0 is the initial value for the sphere to be estimated
    * @param point_cloud is the object point cloud
    */
    /****************************************************************/
...
public:
    ...
    /** Set point to be used for sphere estimation
    * @param point_cloud is the object point cloud
