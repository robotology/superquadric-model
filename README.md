...
An example code for retriving this information, together with a tutorial, is provided in the folder [`example`](https://github.com/robotology/superquadric-model/tree/master/example) in this repository.
